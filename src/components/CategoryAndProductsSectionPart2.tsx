...
const CategoryCard = ({ name, icon, isActive }: { name: string; icon: string; isActive: boolean }) => (
  <div
    className={`flex flex-col items-center justify-center p-6 rounded-lg min-w-[140px] transition-colors cursor-pointer
      ${isActive 
        ? 'bg-red-500 text-white' 
        : 'bg-white hover:bg-gray-50 text-gray-800'}`}
  >
    <Icon icon={icon} className="w-8 h-8 mb-3" />
...
export default function CategoryAndProductsSectionPart2() {
  return (
